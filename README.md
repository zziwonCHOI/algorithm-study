...
3. **문제를 해결한 후 개인 Repository에 Push합니다.**
4. **월, 목에 코드리뷰 진행 후 PR을 제출합니다.**

### 스터디 진행 방식

1. **문제 풀이**
    - 매일 1~3개의 공통 문제를 제공합니다.
    - 풀이한 문제는 다음 모임 전까지 백준 그룹에 제출 후 개인 Repository에 Push합니다.
...
**예시**:
```
kimyeongjoon/백준/Bronze/10998. A×B.java
```
